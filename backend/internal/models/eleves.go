...
type Eleve struct {
	...
	// Alignés sur le wizard de pré-inscription publique pour la fiche élève.
	Nationalite           string                `gorm:"default:'Ivoirienne'" json:"nationalite"`
	AncienEtablissement   string                `json:"ancien_etablissement"`
	StatutAnneePrecedente StatutAnneePrecedente `gorm:"default:NON_APPLICABLE" json:"statut_annee_precedente"`
